...
export const LEVELS: Level[] = [
    ...
    },
    {
        ...
        bodies: [
            ...
            // (the wall runs down across the straight line to Mars, so the way
            // round is a real one; Mars pulls a little harder to catch it)
            { kind: "mars", r: 1.3, mu: 200, at: [40, -12] },
            ...belt([6, 30], [20, -6], 13, 7),
        ],
        start: 0,
        target: 2,
    ...
    },
    {
        ...
        bodies: [
            ...
            { kind: "blackhole", r: 1.4, mu: 3000, at: [4, -4] }, // (across the straight line to the red world)
