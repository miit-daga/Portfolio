...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    useMotionValueEvent(heightTransform, "change", (latestAnimatedLineHeight) => {
        ...
        let finalUniquePoints: { p: number; color: string }[] = [];
        ...
        let trulyFinalPoints: { p: number, color: string }[] = [];
        if (finalUniquePoints.length > 0) {
                ...
                {data.map((item, index) => (
                    ...
                    >
                        ...
                        >
                            ...
                            <h3 className="hidden md:block text-xl md:pl-20 lg:text-2xl font-bold text-neutral-400 ">
                                {item.title}
                            </h3>
                        </div>
