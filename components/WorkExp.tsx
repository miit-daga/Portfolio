            ...
            content: (
                <div className="flex-col">
                    ...
                    <p className="my-5 text-xs font-normal md:text-sm text-neutral-200">
                        Spearheading backend development for multiple high-impact projects at TechWire Studio. Led the development of a comprehensive business management platform for Xceed Electronics. Core functionalities included real-time tracking of in-house inventory, order enquiry processing, and secure role-based admin operations. The platform also integrated the Waldom API to source and manage an extended range of products, with development of its corresponding payment gateway also completed to facilitate sales of these Waldom-specific items. Optimized API workflows to reduce backend latency by over 40%, and deployed the application on AWS to ensure reliability at scale — currently handling over 1000+ inventory and order-related actions monthly.<br />
                        Additionally, designed and developed an internal project management and automated payment portal for TechWire Studio's recurring maintenance clients. This phase included engineering the Razorpay integration for seamless invoicing, which was successfully tested locally. The portal was designed to allow admins to manage client records, project details, and payment tracking. A paywall mechanism was also designed, intended to automatically block client websites post due dates and restore access instantly upon payment confirmation, aimed at significantly reducing collection delays and improving cash flow.
                    </p>
                </div>
            ),
        },
