            ...
            content: (
                <div className="flex-col">
                    ...
                    <p className="my-5 text-xs font-normal md:text-sm text-neutral-200">
                        Spearheading backend development for multiple high-impact projects at TechWire Studio. Led the development of a comprehensive business management platform for Xceed Electronics, featuring real-time inventory tracking, order enquiry processing, and secure role-based admin operations. Optimized API workflows to reduce backend latency by over 40%, and deployed the application on AWS to ensure reliability at scale — currently handling over 1000+ inventory and order-related actions monthly.<br />
