...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      // You can customize the colors here if you don't want the defaults
      // from BackgroundGradientAnimation. For example:
      // sixthColor="255, 105, 180" // Hot Pink
      // seventhColor="75, 0, 130"  // Indigo
      >
