...
export const aboutme = "As a pre-final year B.Tech student in Information Technology at Vellore Institute of Technology, I have a deep passion for backend development and a strong interest in AI and ML. Currently diving into Deep Learning, I eagerly explore new ideas and expand my expertise. Fluent in English, Hindi, Bengali, and Gujarati, engaging with diverse communities and embracing challenges comes naturally. A quick learner and team player, contributing, collaborating, and growing alongside peers is always a priority. Actively seeking opportunities to work on projects that enhance my skills and create a meaningful impact."